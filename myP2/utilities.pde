...
color black=#000000, white=#FFFFFF, // set more colors using Menu >  Tools > Color Selector
   red=#FF0000, green=#00FF01, blue=#0300FF, yellow=#FEFF00, peach=#ED8D8D, orange = #FA6E17,grass=#90FF43,cyan=#00FDFF, magenta=#FF00FB, grey=#5F5F5F;
color [] allColor = {peach, blue, yellow, cyan, magenta, grey};
// ************************************************************************ GRAPHICS 
...
void scribeHeaderRight(String S) { text(S,width-10*S.length(),20); noFill();} // writes black on screen top, right-aligned
